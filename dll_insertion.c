...
4. Exit
Enter your choice: 1
DLL before insertion at beginning
10 <-> 20 <-> 30 <-> NULL
Enter the data to be inserted at the beginning: 0
DLL after insertion at beginning
0 <-> 10 <-> 20 <-> 30 <-> NULL
...
4. Exit
Enter your choice: 2
DLL before insertion at end
0 <-> 10 <-> 20 <-> 30 <-> NULL
Enter the data to be inserted at the end: 40
DLL after insertion at end
0 <-> 10 <-> 20 <-> 30 <-> 40 <-> NULL
...
4. Exit
Enter your choice: 3
DLL before insertion at random
0 <-> 10 <-> 20 <-> 30 <-> 40 <-> NULL
Enter the position where the node should be inserted: 4
Enter the data for the new node: 25
DLL after insertion at random
0 <-> 10 <-> 20 <-> 30 <-> 25 <-> 40 <-> NULL
