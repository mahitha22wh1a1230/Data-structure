...
3. Delete from a random position
4. Exit
Enter your choice: 1
DLL before deletion from the beginning
10 <-> 20 <-> 30 <-> NULL
DLL after deletion from the beginning
20 <-> 30 <-> NULL
...
4. Exit
Enter your choice: 2
DLL before deletion from the end
20 <-> 30 <-> NULL
...
4. Exit
Enter your choice: 3
DLL before deletion from a random position
20 <-> NULL
Enter the position from which the node should be deleted: 1
DLL after deletion from a random position
1645183712 <-> NULL
